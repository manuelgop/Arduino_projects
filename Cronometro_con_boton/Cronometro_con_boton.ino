...
void setup() {
  ...
  pinMode(6, INPUT_PULLUP);                      //Ponemos el pin 6 como entrada para el Sensor START/STOP
  pinMode(7, INPUT_PULLUP);                      //Ponemos el pin 7 como entrada para el Pulsador RESET
